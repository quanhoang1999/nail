        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function () {
                        system.notify('Save user succesful', 'success');
                ...
                if (response.RowCount > 0) {
                    $.each(response.Results, function (i, item) {
                        render += Mustache.render(template, {
                            ...
                            Avatar: item.AvatarFullUrl === undefined ? '<img src="/admin-side/images/user.png" width=25 />' : '<img src="' + item.AvatarFullUrl + '" width=25 />',
