    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        system.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        system.notify('Has an error', 'error');
                        system.stopLoading();
                    }
                });
                return false;
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    system.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    system.stopLoading();
                },
                error: function () {
                    system.notify('Has an error in save permission progress', 'error');
                    system.stopLoading();
                }
            });
        });
