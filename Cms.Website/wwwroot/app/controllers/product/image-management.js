        ...
        $("#fileImage").on('change', function () {
            ...
            $.ajax({
                ...
                success: function (path) {
                    clearFileInput($("#fileImage"));
                    images.push(path);
                    $('#image-list').append('<div class="col-md-3"><img width="100"  data-path="' + path + '" src="/uploaded/images/' + path + '"></div>');
                    ...
                    system.notify('Đã tải ảnh lên thành công!', 'success');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response, function (i, item) {
                    render += '<div class="col-md-3"><img width="100" src="/uploaded/images/' + item.Path + '"><br/><a href="#" class="btn-delete-image">Xóa</a></div>'
                });
