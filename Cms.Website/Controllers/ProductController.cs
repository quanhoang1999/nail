...
using Cms.Website.Models.ProductViewModels;
...
namespace Cms.Website.Controllers
{
    public class ProductController : Controller
    {
        ...
        [Route("egift")]
        public IActionResult Egift()
        {
            var model1 = _productService.GetAll().Where(x => x.CategoryId == 1).ToList();
            EgifAddViewModel model = new EgifAddViewModel()
            {
                GiftCartModels = model1
            };
            return View(model);
        }
