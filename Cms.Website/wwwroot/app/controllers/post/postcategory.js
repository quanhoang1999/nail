var postCategoryController = function () {
    ...
    function registerEvents() {
        ...
        $('body').on('click', '#btnEdit', function (e) {
            ...
            $.ajax({
                type: "GET",
                url: "/Admin/post/GetCategoryById",
                data: { id: that },
                dataType: "json",
                beforeSend: function () {
                    system.startLoading();
        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            system.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        system.notify('Deleted success', 'success');
                        system.stopLoading();
                        loadData();
                    },
                    error: function (status) {
                        system.notify('Has an error in deleting progress', 'error');
                        system.stopLoading();
                    }
                });
            });
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/Admin/Post/SaveEntityCategory",
                    data: {
                        Id: id,
                        Name: name,
                    ...
                    success: function (response) {
                        system.notify('Update success', 'success');
                    ...
                    error: function () {
                        system.notify('Has an error in update progress', 'error');
                        system.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = system.unflattern(data);
